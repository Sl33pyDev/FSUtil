...
import org.fsp.fsutil.client.renderer.PFredbearDisplayItemRenderer;
...
public class PFredbearDisplayItem extends BlockItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public PFredbearDisplayItem(Block block, Properties settings) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new PFredbearDisplayItemRenderer();
        ...
        if (!stack.hasTag() || !stack.getTag().contains("display")) {
            ...
            display.putString("Name", Component.Serializer.toJson(
                    Component.empty()
                            ...
                            .append(Component.literal("FredBear").withStyle(style -> style.withColor(TextColor.fromRgb(0xc39860)).withItalic(false)))));
